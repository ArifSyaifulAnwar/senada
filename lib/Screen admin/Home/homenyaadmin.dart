    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (responseData['Success'] == true) {
          ...
          final errorMsg = responseData['Message'] ?? 'Unknown error from API';
          setState(() {
            _isLoadingNotifications = false;
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (newToken != null) {
          ...
          if (mounted) {
            setState(() {
              _errorMessage = 'Authentication gagal';
              _isLoading = false;
            });
          }
        }
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          if (_unreadNotificationCount > 0 || _debugShowTestBadge)
            Positioned(
    ...
    final List<ServiceIconData> firstRowServices = [
      _buildServiceIconData(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const HalamanAdminReimbursement(),
            ),
          );
        },
      ),
      ...
      _buildServiceIconData(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => TimeOffAdminScreen()),
          );
        },
      ),
      _buildServiceIconData(
    ...
    final List<ServiceIconData> secondRowServices = [
      _buildServiceIconData(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(builder: (context) => OvertimeAdminScreen()),
          );
        },
      ),
      _buildServiceIconData(
