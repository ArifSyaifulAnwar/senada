...
class _HomePageState extends State<HomeScreen> {
  ...
  // NEW: Notification count state - ENHANCED with debugging
  int _unreadNotificationCount = 0;
  bool _isLoadingNotifications = false;
  String? _notificationError;

  // DEBUG: Add test mode to show badge
  bool _debugShowTestBadge = false; // Set to true untuk testing
  String? userID;
  ...
  void initState() {
    ...
    // DEBUG: Uncomment untuk testing badge
    // _debugTestNotificationBadge();
  }

  // DEBUG: Method untuk testing badge
  ...
  void _debugTestNotificationBadge() {
    setState(() {
      _unreadNotificationCount = 5; // Test dengan 5 notifikasi
  ...
  // ENHANCED: Method untuk mengambil jumlah notifikasi yang belum dibaca
  // PERBAIKAN: Method untuk mengambil jumlah notifikasi yang belum dibaca
        ...
        if (result['success']) {
          ...
          setState(() {
            ...
            _attendanceStatusMessage =
                result['message'] ?? 'Gagal mengambil status attendance';
          });
        }
      }
    } catch (e) {
    ...
    Future.delayed(const Duration(milliseconds: 500), () {
      if (mounted &&
        ...
        try {
          ...
          // silently catch the error without printing or logging
          // optionally: you could add a comment or send to analytics if needed
        }
      }
    });
  }
  ...
  // ENHANCED: Widget untuk notification icon dengan badge yang diperbaiki
  // ✅ PERBAIKAN: Widget untuk notification icon dengan badge yang benar
    ...
    return SizedBox(
      ...
      child: Stack(
        ...
        children: [
          ...
          // ✅ PERBAIKAN: Badge hanya muncul jika count > 0 (tidak ada _debugShowTestBadge untuk production)
          ...
          // Error indicator - hanya muncul jika ada error dan tidak loading dan count = 0
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // DEBUG: Notification debug info (comment saat production)
                    if (_debugShowTestBadge || _notificationError != null)
                      _buildNotificationDebugInfo(scale),
  ...
  // DEBUG: Widget untuk menampilkan debug info notifikasi
  Widget _buildNotificationDebugInfo(double scale) {
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            ...
            style: TextStyle(fontSize: 11 * scale, color: Colors.blue.shade600),
          ),
          Text(
            'Loading: $_isLoadingNotifications',
            style: TextStyle(fontSize: 11 * scale, color: Colors.blue.shade600),
          ),
          if (_notificationError != null)
            Text(
      ...
      _buildServiceIconData(
        ...
        onTap: () {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const HalamanReimbursement(),
            ),
          );
        },
      ),
            ...
            children: [
              Row(
                ...
                children: [
                  ...
                  GestureDetector(
                    onTap: () {
                      //print("Navigating to view all tasks");
                    },
                    child: Text(
                      'Lihat Semua',
                      style: TextStyle(
