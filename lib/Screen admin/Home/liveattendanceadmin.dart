...
class LiveAttendanceScreenAdmin extends StatefulWidget {
  ...
  @override
  _LiveAttendanceScreenAdminState createState() => _LiveAttendanceScreenAdminState();
}
...
class _LiveAttendanceScreenAdminState extends State<LiveAttendanceScreenAdmin>
  ...
  bool _isInOfficeArea = true; // Simulate office area detection
  ...
  Future<void> _getCurrentLocation() async {
    ...
    setState(() {
      ...
      _isInOfficeArea = !location.contains('luar area');
    });
  }
